...
parser.add_argument('--path_loadmap', type=str, default='D:/Project/gnn_pathplanning-master/newdata/MultiAgentDataset/Solution_BMap/Storage_Map/BenchMarkMap')
parser.add_argument('--loadmap_TYPE', type=str, default='random')
parser.add_argument('--path_save', type=str, default='D:/Project/gnn_pathplanning-master/newdata/MultiAgentDataset/Solution_DMap')
