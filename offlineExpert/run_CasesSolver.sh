...
python CasesSolver.py   --gen_CasePool --chosen_solver ECBS  --num_agents 10 --num_caseSetup_pEnv 5000  --loadmap_TYPE random --path_save D:/Project/gnn_pathplanning-master/newdata
