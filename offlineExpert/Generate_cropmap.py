...
parser.add_argument('--map_width', type=int, default=100)
parser.add_argument('--map_density', type=float, default=0.1)
parser.add_argument('--map_complexity', type=float, default=0.002)
parser.add_argument('--num_agents', type=int, default=50)
parser.add_argument('--num_dataset', type=int, default=800)
...
parser.add_argument('--path_loadmap', type=str, default='D:/Project/gnn_pathplanning-master/newdata/MultiAgentDataset')
...
if __name__ == '__main__':
    ...
    path_savedata = 'D:/Project/gnn_pathplanning-master/newdata'
